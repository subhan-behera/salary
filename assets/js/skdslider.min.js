! function(e) {
    e.skdslider = function(i, t) {
        ...
        t && e.extend(n, t), n.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch, e(i).wrap('<div class="skdslider" id="sliderbanner"></div>');
        ...
        if (n.currentSlide = 0, n.currentState = "pause", n.running = !1, n.stopSlidingAfter && ("all" == n.stopSlidingAfter && (n.stopSlidingAfter = a.length), n.stopSlidingAfter -= 1), "fading" == n.animationType) {
            var o = Math.ceil(s * (l.outerWidth(!1) / r));
            l.css({
                height: o
            }), a.each(function() {
                e(this).css({
                ...
                var e = Math.ceil(s * (l.outerWidth(!1) / r));
                l.css({
                    height: e
                })
            })
        ...
        if ("sliding" == n.animationType) {
            ...
            var u = l.outerWidth(!1) * a.size(),
                o = Math.ceil(s * (l.outerWidth(!1) / r));
            l.find("ul.slides").css({
                position: "absolute",
                left: "0",
                width: u
            }), a.css({
                width: l.outerWidth(!1),
                height: o
            }), l.css({
                height: o
            }), e(window).resize(function() {
                var e = l.outerWidth(!1) * a.size(),
                    i = Math.ceil(s * (l.outerWidth(!1) / r));
                l.find("ul.slides").css({
                    position: "absolute",
                    left: "0",
                    width: e
